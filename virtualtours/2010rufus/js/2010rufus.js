(function () {
      ...
      function init (preserveDrawingBuffer) {
        ...
        if (startPos == null || startPos == ""){
          panorama.setImage("media/textures/2010rufus/001.jpg");
          arrayPos = 1;
        }
        else {
          panorama.setImage("media/textures/2010rufus/"+startPos+".jpg");
      ...
      function onNext () {
        ...
        toggleTo(true, "media/textures/2010rufus/"+posString+".jpg");
      }
