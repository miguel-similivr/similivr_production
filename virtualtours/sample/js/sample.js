(function () {
      ...
      function init (preserveDrawingBuffer) {
        ...
        if (startPos == null || startPos == ""){
          panorama.setImage("media/textures/sample/sample_001.jpg");
          arrayPos = 1;
        }
        else {
          panorama.setImage("media/textures/sample/sample_"+startPos+".jpg");
      ...
      function onNext () {
        ...
        toggleTo(true, "media/textures/sample/sample_"+posString+".jpg");
      }
