(function () {
      ...
      function init (preserveDrawingBuffer) {
        ...
        if (startPos == null || startPos == ""){
          panorama.setImage("media/textures/16stw/16stw_001.jpg");
          arrayPos = 1;
        }
        else {
          panorama.setImage("media/textures/16stw/16stw_"+startPos+".jpg");
      ...
      function onNext () {
        ...
        toggleTo(true, "media/textures/16stw/16stw_"+posString+".jpg");
      }
